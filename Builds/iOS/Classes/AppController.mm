...
#include "../Libraries/FacebookUnityManager.h"
#include "../Libraries/GameCenterUnityManager.h"
#include "../Libraries/MoreAppsUnityManager.h"
#include "../Libraries/ViewControllerWrapper.h"
#include "../Libraries/SocialUnityManager.h"
...
- (void) applicationDidBecomeActive:(UIApplication*)application
{
    ...
    if (_didResignActive) {
        [[[FacebookUnityManager sharedManager] session] handleDidBecomeActive];
        ...
        for (id obj in [[[UIApplication sharedApplication] keyWindow] subviews]){
            if([[obj class] isSubclassOfClass:[WrapperView class]]) {
                    [(WrapperView *) obj removeFromSuperview];
                    [(WrapperView *) obj release];
                    obj = nil;
            }
        }
        if(![[GameCenterUnityManager sharedManager] isViewControllerWrapperPresent] && ![[MoreAppsUnityManager sharedManager] isViewControllerWrapperPresent] && ![[SocialUnityManager sharedManager] isViewControllerWrapperPresent]) {
            UnityPause(false);
        }
    }
...
- (void) applicationWillTerminate:(UIApplication*)application
{
    ...
    [[[FacebookUnityManager sharedManager] session] close];
...
{
    return [[[FacebookUnityManager sharedManager] session] handleOpenURL:url];
}
